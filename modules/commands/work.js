...
var coinsdv = Math.floor(Math.random() * 10000) + 100; //random coins khi làm ở khu dịch vụ
var coinsmd = Math.floor(Math.random() * 20000) + 400; //random coins khi làm ở mỏ dầu
var coinsq = Math.floor(Math.random() * 200000) + 90; //random coins khi khai thác quặng
var coinsdd = Math.floor(Math.random() * 5000) + 200; //random coins khi đào đá
var coinsdd1 = Math.floor(Math.random() * 4000) + 600; //random coins khi đào đá
var coinsex2 = Math.floor(Math.random() * 20000) + 500;
  var coinsktf = Math.floor(Math.random() * 30000) + 200;
