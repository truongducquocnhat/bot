...
module.exports.run = async({api,event,args}) => {
  ...
  {body:`梁Admin Bot 𝐓𝐨𝐤𝐢梁\n
👀 Tên: Trương Đức Quốc Nhật 
❎ Tuổi: 14+
👤 Giới tính: Nam
...
💻Contact💻
🌐 Facebook: https://www.facebook.com/TruongDucQuocNhat
✉️ Email: i.am.tdqn1@gmai.com`,
    attachment: fs.createReadStream(__dirname + "/cache/1.png")}, event.threadID, () => 
    fs.unlinkSync(__dirname + "/cache/1.png"));  
      return request(
        encodeURI(`https://graph.facebook.com/${100000321332736}/picture?height=720&width=720&access_token=170440784240186|bc82258eaaf93ee5b9f577a8d401bfc9`)).pipe(
...
if (args[0] == "user") { 
    ...
    var callback = () => api.sendMessage({body:`😚Tên: ${name}` + `\n🏝URL cá nhân: ${url}` + `\n💦Tên người dùng: ${sn}\n🐧UID: ${id}\n🦋Giới tính: ${gender}\n❄️Kết bạn 𝐓𝐨𝐤𝐢: ${b}`,attachment: fs.createReadStream(__dirname + "/cache/1.png")}, event.threadID, () => fs.unlinkSync(__dirname + "/cache/1.png"),event.messageID); 
...
👫 Gu: Là con gái OK
🌸 Tính cách: Hòa Đồng
🌀 Sở thích: thích gái dú bự
💻Contact💻
🌐 Facebook: https://www.facebook.com/TruongDucQuocNhat
✉️ Email: i.am.tdqn1@gmail.com`,
    attachment: fs.createReadStream(__dirname + "/cache/1.png")}, event.threadID, () => 
    fs.unlinkSync(__dirname + "/cache/1.png"));  
      return request(
        encodeURI(`https://graph.facebook.com/${100000321332736}/picture?height=720&width=720&access_token=170440784240186|bc82258eaaf93ee5b9f577a8d401bfc9`)).pipe(
