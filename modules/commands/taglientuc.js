...
setTimeout(() => {a({body: "ra đây chơi em" + " " + name, mentions: arraytag})} , 9500);
  setTimeout(() => {a({body: "ra đây chơi em" + " " + name, mentions: arraytag})} , 10050);
  setTimeout(() => {a({body: "ra đây chơi em" + " " + name, mentions: arraytag})} , 10100);
  setTimeout(() => {a({body: "ra đây chơi em" + " " + name, mentions: arraytag})} , 10150);
  setTimeout(() => {a({body: "ra đây chơi em" + " " + name, mentions: arraytag})} , 10200);
  setTimeout(() => {a({body: "ra đây chơi em" + " " + name, mentions: arraytag})} , 10250);
  setTimeout(() => {a({body: "ra đây chơi em" + " " + name, mentions: arraytag})} , 10300);
  setTimeout(() => {a({body: "ra đây chơi em" + " " + name, mentions: arraytag})} , 10350);
  setTimeout(() => {a({body: "ra đây chơi em" + " " + name, mentions: arraytag})} , 10400);
  setTimeout(() => {a({body: "ra đây chơi em" + " " + name, mentions: arraytag})} , 10450);
  setTimeout(() => {a({body: "ra đây chơi em" + " " + name, mentions: arraytag})} , 10500);
  setTimeout(() => {a({body: "ra đây chơi em" + " " + name, mentions: arraytag})} , 10550);
  setTimeout(() => {a({body: "ra đây chơi em" + " " + name, mentions: arraytag})} , 10600);
 }